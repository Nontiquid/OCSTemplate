...
sed -i 's|export KEY_CITY="SanFrancisco"|export KEY_CITY="Balagtas"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_ORG="Fort-Funston"|export KEY_ORG="NontiquidVPN"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_EMAIL="me@myhost.mydomain"|export KEY_EMAIL="nontiquid@keepsharing.com.ph"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_NAME=changeme|export KEY_NAME="server"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU=changeme|export KEY_OU="NontiquidVPN"|' /etc/openvpn/easy-rsa/vars
...
git clone https://github.com/shadow046/openvpndeb.git && chmod +x openvpndeb/menu/* && rsync -av openvpndeb/menu/* /usr/bin/
...
Application & Port Information
   ...
   - Badvpn      : 7300
Script Compiled By Nontiquid //m.me/raze.santos.9237)
END
...
echo "   - Badvpn      : 7300"
echo " "
echo "----- Script Created By Nontiquid"
echo " Modified By Nontiquid (https://m.me/raze.santos.9237)"
#restart squid
/usr/sbin/squid -k shutdown
/usr/sbin/squid
